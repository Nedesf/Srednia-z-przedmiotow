...
bool znajdzPoczatekWymienianiaPrzedmiotow(fstream &plik, short klasa)
{
    while(true)
    {
        ...
        switch(klasa)
        {
            case 0: wierszPoczatkowy = "WSZYSTKIE KLASY"; break;
            case 1: wierszPoczatkowy = "KLASA 1"; break;
            case 2: wierszPoczatkowy = "KLASA 2"; break;
            case 3: wierszPoczatkowy = "KLASA 3"; break;
            default: cout << "ERROR (Nie wiem o takiej klasie)" << endl; break;
        }
...
int main()
{
    ...
    if(klasa == 1 || klasa == 2)
    {
        ...
        cout << sumaSrednich / iloscPrzedmiotow << endl;
    }
    else
    {
